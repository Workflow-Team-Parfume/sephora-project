...
export const newProducts = ([
    ...
    },
    {
        ...
        volume: [{volume: "60мл", price: '1 307'}],
        rating: 2,
        isNew: true,
        description: "",
        characteristics: [],
...
export const Perfume: IProduct[] = ([
    ...
    },
    {
        ...
        rating: 5,
        volume: [{volume: '30ml', price: '3 750'}],
        isNew: false,
        description: "",
        characteristics: [],
        codeProduct: 123,
...
export const similarProducts = ([
    {
        ...
        categoryName: "Парфумована вода",
        volume: [{volume: '90ml', price: '4 171'}],
        rating: 4,
        isNew: false,
        description: "",
        characteristics: [],
    ...
    },
    {
        ...
        pictures: [dior1],
        categoryName: "Парфумована вода",
        volume: [{volume: '100ml', price: '6 430'}],
        rating: 3,
        isNew: false,
        description: "",
        characteristics: [],
    ...
    },
    {
        ...
        pictures: [dior2],
        categoryName: "Парфумована вода",
        volume: [{volume: '30ml', price: '3 614'}],
        rating: 3,
        isNew: false,
        description: "",
        characteristics: [],
...
export const especiallyForYou = ([
    ...
    },
    {
        ...
        pictures: [burberry2],
        categoryName: "Парфумована вода",
        volume: [{volume: '50ml', price: '1 853'}],
        rating: 3,
        isNew: false,
        description: "",
        characteristics: [],

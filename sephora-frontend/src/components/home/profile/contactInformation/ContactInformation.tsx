                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={12} md={6} lg={6}>
                            <Stack spacing={2}>
                                ...
                                <Stack>
                                    <Stack className="text">{t('profile.contactInformation.passwordVerification')}</Stack>
                                    <Field
                                        as={FormControl}
                                        sx={{ ...textFieldStyle }}
                                        variant="outlined"
                        ...
                        >
                            <input
                                ...
                                accept="image/*"
                                style={{ display: 'none' }}
                                onChange={(event: React.ChangeEvent<HTMLInputElement>) => {const file = event.target.files?.[0];
                                    if (file) {
